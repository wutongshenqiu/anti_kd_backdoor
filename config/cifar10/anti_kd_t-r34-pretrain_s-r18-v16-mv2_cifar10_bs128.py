trainer = dict(
    type='AntiKDTrainer',
    teacher=dict(network=dict(
        arch='cifar',
        type='resnet34',
        num_classes=10,
        checkpoint='work_dirs/normal_r34_cifar10_bs128/ckpt/latest_network.pth'
    ),
        ...
        transform=[
            ...
            dict(type='Normalize',
                 ...
                 std=(0.2023, 0.1994, 0.2010))
                                 ...
                                 pin_memory=True,
                                 shuffle=True),
    poison_test_dataloader=dict(dataset=dict(type='RatioPoisonLabelCIFAR10',
                                             ratio=1,
                                             poison_label=1,
                                             root='data',
                                             train=False,
