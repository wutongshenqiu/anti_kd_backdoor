...
num_workers = 2
pin_memory = True
teacher_checkpoint_path = 'cifar10_work_dirs/finetune_epoch=20_shufflenetv2_x1_0_cifar10-ratio=0.1_bs128/ckpt/latest_network.pth'  # noqa: E501

trainer = dict(
    type='NADlTrainer',
    teacher=dict(arch='chenyaofo_cifar_models',
                 type='cifar10_shufflenetv2_x1_0',
                 pretrained=False,
    ...
    loss_mapping=dict(at_loss1=dict(teacher='stage2',
                      ...
                      at_loss3=dict(teacher='stage4',
                                    ...
                                    loss=dict(p=2., eps=1e-6),
                                    weight=1000)),
    train_dataloader=dict(dataset=dict(type='RatioCIFAR10',
                                       ratio=0.05,
                                       root='data',
                                       train=True,
                                       download=True,
