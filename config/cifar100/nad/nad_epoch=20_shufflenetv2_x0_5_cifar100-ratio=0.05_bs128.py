...
num_workers = 2
pin_memory = True
teacher_checkpoint_path = 'cifar100_work_dirs/finetune_epoch=20_shufflenetv2_x0_5_cifar100-ratio=0.1_bs128/ckpt/latest_network.pth'  # noqa: E501

trainer = dict(
    type='NADlTrainer',
    teacher=dict(arch='chenyaofo_cifar_models',
                 type='cifar100_shufflenetv2_x0_5',
                 pretrained=False,
